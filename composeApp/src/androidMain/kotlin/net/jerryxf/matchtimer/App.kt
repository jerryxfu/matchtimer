...
fun App() {
    ...
    val matchState by timer.matchState.collectAsState()
    ...
    MaterialTheme {
        Surface(
            ...
            Column(
                ...
                Text(matchState.timeString(), fontSize = 50.sp)
                Row(Modifier.fillMaxWidth(), Arrangement.SpaceEvenly) {
                    Spacer(Modifier.width(10.dp))
                    Button({ timer.start(coroutineScope) }, Modifier.weight(.5f)) { Text("Start") }
                    Spacer(Modifier.width(10.dp))
